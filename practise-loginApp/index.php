...
<div  class="container d-flex align-items-center justify-content-center">
    <div class="card <?= cookie('color') ?>" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            if (get('islem') == true){
                echo '<div class="aler alert-success">İşlem Başarılı</div>';
            } else if (get('islem') == 'false'){
                echo '<div class="aler alert-danger">İşlem Başarısız</div>';
            }

            ?>

            <form action="islem.php?islem=hakkimda" method="post">
                <textarea class="form-control <?= cookie('color') ?> text-primary" name="hakkimda" id="" cols="30" rows="10"><?= htmlspecialchars_decode($hakkimda); ?></textarea>
